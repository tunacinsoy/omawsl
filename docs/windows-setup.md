...
`eza`) matches: picking Cascadia Mono there switches starship to its plain, no-Nerd-Font
preset instead of the icon-based default, which would otherwise render as a tofu box without a
matching Nerd Font.
